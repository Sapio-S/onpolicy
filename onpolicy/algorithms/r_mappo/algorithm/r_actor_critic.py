...
class R_Actor(nn.Module):
    ...
    def distill_evaluate_actions(self, obs, rnn_states, action, masks, available_actions=None, active_masks=None):
        ...
        action_log_probs, dist_entropy, dist_rep = self.act.distill_evaluate_actions(actor_features, action, available_actions, active_masks = active_masks if self._use_policy_active_masks else None)
