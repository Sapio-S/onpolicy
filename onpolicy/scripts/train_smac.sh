...
do
    ...
    --ppo_epoch 15 --clip_param 0.2 --n_training_threads 1 --n_rollout_threads 8 --num_mini_batch 1 --episode_length 100 --num_env_steps 3000000 --ppo_epoch 15 --use_value_active_masks --use_eval --use_state_agent --lr 5e-4 --use_recurrent_policy False
