...
do
    ...
    --model_dir /home/eva_data/xyq/onpolicy/onpolicy/scripts/results/StarCraft2/3s5z/distill/mappo_torchKL/wandb/run-20220919_003933-2sbrgq84/files --use_recurrent_policy
done
