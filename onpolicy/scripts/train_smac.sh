...
do
    ...
    echo "algo is ${algo}"
    CUDA_VISIBLE_DEVICES=1 python train/train_smac.py --env_name ${env} --algorithm_name ${algo} --experiment_name ${exp} --map_name ${map} --seed ${seed} \
    --n_training_threads 1 --n_rollout_threads 2 --episode_length 400 --num_env_steps 5000000 --num_mini_batch 1 --ppo_epoch 5 --clip_param 0.2 --gain 0.01 --use_value_active_masks --use_eval --use_wandb
