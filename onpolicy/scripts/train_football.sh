...
do
    ...
    --num_env_steps 25000000 --n_rollout_threads 50 --ppo_epoch 15 --episode_length 200 --num_mini_batch 2 --data_chunk_length 10 --use_eval --eval_episodes 100 --n_eval_rollout_threads 100
    ...
    algo="mat"
    CUDA_VISIBLE_DEVICES=0 python train/train_football.py --seed ${seed} --env_name ${env} --algorithm_name ${algo} --experiment_name ${exp} --scenario ${scenario} --n_agent ${n_agent} \
    --num_env_steps 25000000 --n_rollout_threads 50 --ppo_epoch 15 --episode_length 200 --num_mini_batch 1 --use_eval --eval_episodes 100 --n_eval_rollout_threads 100 --ppo_epoch 10 --clip_param 0.05 --use_eval --use_value_active_masks --use_policy_active_masks --use_recurrent_policy
