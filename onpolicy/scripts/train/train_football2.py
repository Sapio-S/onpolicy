...
from onpolicy.envs.football_mappo.Football_Env import FootballEnv
...
def main(args):
    ...
    elif all_args.algorithm_name == "mappo" or all_args.algorithm_name == "mappg" or all_args.algorithm_name == "mat" or all_args.algorithm_name == "mat_dec":
    ...
    if all_args.share_policy:
        from onpolicy.runner.shared.football_runner_mappo import FootballRunner as Runner
    else:
