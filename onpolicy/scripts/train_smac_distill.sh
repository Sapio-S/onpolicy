...
do
    ...
    CUDA_VISIBLE_DEVICES=4 python train/train_smac.py --env_name ${env} --algorithm_name ${algo} --experiment_name ${exp} --map_name ${map} --seed ${seed} \
     --n_training_threads 1 --n_rollout_threads 8 --num_mini_batch 2 --episode_length 400 --num_env_steps 10000000 --ppo_epoch 5 --use_value_active_masks --use_eval --add_center_xy --use_state_agent --gain 1 \
     --load_teacher '/home/gaojiaxuan/onpolicy/onpolicy/scripts/teacher.yml' --distill_epoch 10
