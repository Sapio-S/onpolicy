...
--lr 5e-4 --ppo_epoch 15 --clip_param 0.2 --use_recurrent_policy False \
--entropy_coef 0.001 --max_grad_nodrm 0.5 --eval_episodes 5 --n_training_threads 16 --n_rollout_threads 40 --num_mini_batch 40 --episode_length 100 --eval_interval 25 --num_env_steps 10000000 \
--layer_N 2 --use_eval --add_center_xy --use_state_agent --use_value_active_masks --use_policy_active_masks
#--critic_lr 5e-3 --lr 5e-6 --ppo_epoch 5 --clip_param 0.2 \
