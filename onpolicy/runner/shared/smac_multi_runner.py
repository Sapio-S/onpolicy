...
class SMACMultiRunner(Runner):
    ...
    def eval(self, total_num_steps):
        ...
        for eval_map in eval_total_reward.keys():
            ...
            if self.use_wandb:
                wandb.log({eval_map + "/eval_average_episode_rewards": aver_eval_reward}, step=total_num_steps)
            else:
            ...
            if self.use_wandb:
                wandb.log({eval_map + "/eval_win_rate": aver_eval_winrate}, step=total_num_steps)
            else:
